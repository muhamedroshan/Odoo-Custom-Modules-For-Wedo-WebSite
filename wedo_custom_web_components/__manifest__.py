{
    ...
    'data': [
        ...
        'views/snippets/s_odoo_partner.xml',
        'views/snippets/s_trusted_partners.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'wedo_custom_web_components/static/src/css/odoo_partner.css',
            'wedo_custom_web_components/static/src/css/trusted_partners.css',
        ],
    },
    'demo': [],
}
